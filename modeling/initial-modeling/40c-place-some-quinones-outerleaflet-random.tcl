file delete -force -- random-picked-quinones-outer
file mkdir random-picked-quinones-outer
...
for {set counter 1} {$counter <= 100} {incr counter} {
  ...
  $qsel writejs random-picked-quinones-outer/OuterQ-${counter}.js
  $qsel delete
  mol delete $qmol
...
$writesel writejs Ves30-POPE-proteins-carved-0.5-quinoneholes-random1.js
